...
export class OrderRepository {
  ...
  constructor(@Inject("DATA_SOURCE") private readonly dataSource: DataSource, private readonly productRepos: ProductRepository, private readonly userRepos: UserRepository) {
